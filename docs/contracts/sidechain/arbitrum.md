...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#ArbitrumBridge.constructor(address,contract IAugur)"><code class="function-signature">constructor(address _pushBridgeAddress, contract IAugur _augur)</code></a></li><li><a href="#ArbitrumBridge.registerArbchain(address,address,address)"><code class="function-signature">registerArbchain(address _arbChainAddress, address _inboxAddress, address _marketGetterAddress)</code></a></li><li><a href="#ArbitrumBridge.pushBridgeData(address,address,uint256,uint256)"><code class="function-signature">pushBridgeData(address _marketAddress, address _arbChainAddress, uint256 _arbGasPrice, uint256 _arbGasLimit)</code></a></li><li><a href="#ArbitrumBridge.pushFeeData(address,address,uint256,uint256)"><code class="function-signature">pushFeeData(address _universeAddress, address _arbChainAddress, uint256 _arbGasPrice, uint256 _arbGasLimit)</code></a></li><li><a href="#ArbitrumBridge.transferOwnership(address)"><code class="function-signature">transferOwnership(address _newOwner)</code></a></li></ul></div>



<h4><a class="anchor" aria-hidden="true" id="ArbitrumBridge.constructor(address,contract IAugur)"></a><code class="function-signature">constructor(address _pushBridgeAddress, contract IAugur _augur)</code><span class="function-visibility">public</span></h4>
...
<h4><a class="anchor" aria-hidden="true" id="ArbitrumBridge.pushBridgeData(address,address,uint256,uint256)"></a><code class="function-signature">pushBridgeData(address _marketAddress, address _arbChainAddress, uint256 _arbGasPrice, uint256 _arbGasLimit) <span class="return-arrow">→</span> <span class="return-type">bool</span></code><span class="function-visibility">external</span></h4>





<h4><a class="anchor" aria-hidden="true" id="ArbitrumBridge.pushFeeData(address,address,uint256,uint256)"></a><code class="function-signature">pushFeeData(address _universeAddress, address _arbChainAddress, uint256 _arbGasPrice, uint256 _arbGasLimit) <span class="return-arrow">→</span> <span class="return-type">bool</span></code><span class="function-visibility">external</span></h4>
...
<div class="contract-index"><span class="contract-index-title">Functions</span><ul><li><a href="#IGlobalInbox.sendL2Message(address,bytes)"><code class="function-signature">sendL2Message(address chain, bytes messageData)</code></a></li></ul></div>
...
<h4><a class="anchor" aria-hidden="true" id="ArbitrumMarketGetter.receiveFeeData(bytes)"></a><code class="function-signature">receiveFeeData(bytes _feeData) <span class="return-arrow">→</span> <span class="return-type">bool</span></code><span class="function-visibility">external</span></h4>
